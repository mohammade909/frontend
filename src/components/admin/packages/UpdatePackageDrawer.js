...
const UpdatePackageDrawer = ({ open, setOpen, id }) => {
  ...
  const { package:packaged } = useSelector((state) => state.packages);
  ...
  const initialValues = {
    package_name: packaged.package_name || "",
    level_1: "",
    level_2: "",
    risk: "",
    swap: null,
...
export default UpdatePackageDrawer;
